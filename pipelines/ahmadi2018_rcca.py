...
Ahmadi 2018 rCCA
=================
This script shows an example of how to classify the Ahmadi et al. 2018 dataset using rCCA. This dataset can be
...
References
----------
.. [1] Ahmadi et al. (2018). High density EEG measurement. DOI: https://doi.org/10.34973/psaf-mq72
...
path = os.path.join(home, "data", "ahmadi2018")  # the path to the dataset
...
# Load data
fn = os.path.join(path, "sourcedata", f"{subject}.mat")
tmp = loadmat(fn)
...
# Read cap file
capfile = os.path.join(os.path.dirname(pyntbci.__file__), "capfiles", "biosemi256.loc")
fid = open(capfile, "r")
channels = []
