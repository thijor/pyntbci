...
class TestDeBruijnSequence(unittest.TestCase):
    ...
    def test_code_shape(self):
        k = 2
        n = 6
        code = pyntbci.codes.make_de_bruijn_sequence(k=k, n=n)
    ...
    def test_code_is_msequence(self):
        ...
        n = 6
        code = pyntbci.codes.make_de_bruijn_sequence(k=k, n=n)
        self.assertTrue(pyntbci.codes.is_de_bruijn_sequence(code, k=k, n=n))


class TestAPASequence(unittest.TestCase):

    def test_code_shape(self):
        code = pyntbci.codes.make_apa_sequence()
        self.assertEqual(code.shape[0], 1)
...
class TestGolaySequence(unittest.TestCase):
    ...
    def test_code_shape(self):
        code = pyntbci.codes.make_golay_sequence()
...
class TestGoldCodes(unittest.TestCase):
    ...
    def test_codes_shape(self):
        poly1 = (1, 0, 0, 0, 0, 1)
        poly2 = (1, 1, 0, 0, 1, 1)
        codes = pyntbci.codes.make_gold_codes(poly1=poly1, poly2=poly2)
    ...
    def test_codes_is_goldcode(self):
        ...
        poly2 = (1, 1, 0, 0, 1, 1)
        codes = pyntbci.codes.make_gold_codes(poly1=poly1, poly2=poly2)
        self.assertTrue(pyntbci.codes.is_gold_codes(codes))
...
class TestMSequence(unittest.TestCase):
    ...
    def test_code_shape(self):
        base = 2
        poly = (1, 0, 0, 0, 0, 1)
        code = pyntbci.codes.make_m_sequence(poly=poly, base=base)
        self.assertEqual(code.shape[0], 1)
    ...
    def test_code_is_msequence(self):
        ...
        poly = (1, 0, 0, 0, 0, 1)
        code = pyntbci.codes.make_m_sequence(poly=poly, base=base)
        self.assertTrue(pyntbci.codes.is_m_sequence(code))
...
class TestModulation(unittest.TestCase):
    ...
    def test_codes_shape(self):
        ...
        modulated_codes = pyntbci.codes.modulate(codes)
